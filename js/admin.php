    ...
    <div class="intro-header">
		 ...
		 <div class="row">
			 ...
			 <ul class="list-inline intro-social-buttons">
							...
							<li>
                                <a href="https://cloud.saplumira.com/open?key=53D4699B75F3787CE10000000A4E4243&type=HANALYTIC" class="btn btn-default btn-lg"><span class="network-name">School Analysis</span></a>
                            </li>
                            <li>
