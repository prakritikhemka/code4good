...
$q = "select * from users where name = '".mysql_real_escape_string($_POST['username'])."'";
...
<body>
    ...
    <div class="intro-header">
        ...
        <input name="user_name" id="user_name" type="text" class="input-block-level" placeholder="User Name">
