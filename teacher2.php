...
$q="insert into f_teacher_train(trainername,meaning,engaging,pace) values (	'$trainername','$meaningful','$engaging','$pace')";
echo $q;
...
<html lang="en">
 ...
 <body>
   ...
   <div class="container">
     ...
     <form name="register" class="form-signin" method="post" id="user_login" action="teacher2.php">
...
<input name="meaning" id="meaning" type="text" class="input-block-level" placeholder="Placement was meaningful">
